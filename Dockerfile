...
RUN set -x \
    ...
    && curl -sL https://deb.nodesource.com/setup_8.x | bash \
	 && apt-get update && apt-get install -y libdb4.8-dev libdb4.8++-dev  libzmq3-dev  libminiupnpc-dev libboost-all-dev libqt5gui5 libqt5core5a libqt5dbus5 qttools5-dev qttools5-dev-tools nodejs \
